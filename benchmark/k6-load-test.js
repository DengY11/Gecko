...
export const options = {
  ...
  stages: [
    ...
    { duration: '1m', target: 500 },    // 增压: 1分钟内增加到50个用户
    { duration: '2m', target: 1000 },   // 高压: 2分钟内增加到100个用户
    { duration: '1m', target: 2000 },   // 峰值: 1分钟内增加到200个用户
    { duration: '30s', target: 1000 },  // 降压: 30秒内降到100个用户
